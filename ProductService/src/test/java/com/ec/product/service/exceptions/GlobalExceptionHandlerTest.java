package com.ec.product.service.exceptions;

import com.ec.product.service.exceptions.customexceptions.ResourceNotFoundException;
import com.ec.product.service.exceptions.globalexceptions.GlobalExceptionHandler;
...
class GlobalExceptionHandlerTest {
    ...
    void testHandleResourceNotFound() {
        ...
        when(errorResponse.responseHandler("Product not found", HttpStatus.NOT_FOUND))
        ...
        verify(errorResponse, times(1)).responseHandler("Product not found", HttpStatus.NOT_FOUND);
    }

package com.ec.inventory.service.exceptions;

import com.ec.inventory.service.exceptions.customexceptions.ResourceNotFoundException;
import com.ec.inventory.service.exceptions.globalexceptions.GlobalExceptionHandler;
...
class GlobalExceptionHandlerTest {
    ...
    void testHandleResourceNotFound() {
        ResourceNotFoundException ex = new ResourceNotFoundException("Inventory not found");

        when(errorResponse.responseHandler("Inventory not found", HttpStatus.NOT_FOUND))
        ...
        verify(errorResponse, times(1)).responseHandler("Inventory not found", HttpStatus.NOT_FOUND);
    }

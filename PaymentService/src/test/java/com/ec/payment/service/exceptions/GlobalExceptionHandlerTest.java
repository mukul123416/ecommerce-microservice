package com.ec.payment.service.exceptions;

import com.ec.payment.service.exceptions.customexceptions.ResourceNotFoundException;
import com.ec.payment.service.exceptions.globalexceptions.GlobalExceptionHandler;
...
class GlobalExceptionHandlerTest {
    ...
    void testHandleResourceNotFound() {
        ...
        when(errorResponse.responseHandler("Payment not found", HttpStatus.NOT_FOUND))
        ...
        verify(errorResponse, times(1)).responseHandler("Payment not found", HttpStatus.NOT_FOUND);
    }

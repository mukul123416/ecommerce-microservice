package com.ec.user.service.exceptions;

import com.ec.user.service.exceptions.customexceptions.ResourceNotFoundException;
import com.ec.user.service.exceptions.globalexceptions.GlobalExceptionHandler;
...
class GlobalExceptionHandlerTest {
    ...
    void testHandleResourceNotFound() {
        ...
        when(errorResponse.responseHandler("User not found", HttpStatus.NOT_FOUND))
        ...
        verify(errorResponse, times(1)).responseHandler("User not found", HttpStatus.NOT_FOUND);
    }
